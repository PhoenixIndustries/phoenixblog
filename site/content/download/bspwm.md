...
Tags = [ "community" ]
shortDescription = "Bspwm is extremely resource efficient and configurable window manager that follows Unix philosophy. It gives the user maximal control over windows with minimal effort required. Bspwm edition has a focus on terminal application and is not very beginner friendly"
Thumbnail = "bspwm.jpg"
Version = "18.0.4"
